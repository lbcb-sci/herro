...
extern "C" {
    pub fn wavefront_penalties_get_score_indel(
        wf_penalties: *mut wavefront_penalties_t,
        score: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn wavefront_penalties_get_score_edit(
        wf_penalties: *mut wavefront_penalties_t,
        score: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn wavefront_penalties_get_score_linear(
        wf_penalties: *mut wavefront_penalties_t,
        score: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn wavefront_penalties_get_score_affine(
        wf_penalties: *mut wavefront_penalties_t,
        score: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn wavefront_penalties_get_score_affine2p(
        wf_penalties: *mut wavefront_penalties_t,
        score: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
